<template>
  <el-card>
    <ImForm ref="ImForm" :form="formConfig">
      ...
      <EmployeeSelect slot="EmployeeSelect1" v-model="formConfig.props.userOppositeDTOList" allow-create filterable multiple class="w-full" placeholder="请选择"></EmployeeSelect>
